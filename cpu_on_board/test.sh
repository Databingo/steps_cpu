...
#
#go run ../rvas.go copy_sd_to_sdram4.s ok
...
riscv64-unknown-elf-ld -o linked.elf   relocatable.elf  -Ttext 0x0 -Tdata 0xa00  # linker 
#riscv64-unknown-elf-ld -o linked.elf   relocatable.elf  -Ttext 0x80200000 -Tdata 0x80200a00
...
#cp fw_jump_ns16550a.bin fw_jump_pad.bin
cp fw_jump_ns16550a_call_log_noplic40x2004.bin fw_jump_pad.bin
