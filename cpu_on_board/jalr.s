...
#_start:
#    # --- Setup ---
#    # Get the absolute address of 'base_label' into t0 using the JAL trick.
#    jal t0, get_pc_helper
#get_pc_helper:
#    # t0 now holds the address of this line.
#    # `base_label` is 4 instructions ahead, so the offset is 16 bytes.
#    addi t0, t0, 16   # t0 now holds the absolute address of 'base_label'
#
#    # --- The Test ---
#    # Jump to the address in t0 PLUS an offset of 8.
#    # The target should be `base_label + 8`, which is the 'pass_target' label.
#    jalr x0, 8(t0)
#
#    # This part should not be executed.
#    j hang
#
## --- Code block to test the jump ---
#base_label:
#    # This instruction is at base_label + 0. It should be skipped.
