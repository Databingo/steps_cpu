...
_start:
    ...
    addi t1, x0, 80
    sw t1, -16(t0)        # Store 80 P to address 0x2004-16.
    lb t2, -16(t0)        # Load 80 to t2
    sw t2, 0(t0)          # Print  

    #addi t1, x0, 65 
    #sw t1, -15(t0)        # Store 65 A to address 0x2004-15.
    #lb t2, -15(t0)        # Load 65 to t2
    #sw t2, 0(t0)          # Print  

    #addi t1, x0, 115 
    #sw t1, -13(t0)        # Store 115 s to address 0x2004-13.
    #lb t2, -13(t0)        # Load to t2
    #sw t2, 0(t0)          # Print  

    #addi t1, x0, 83 
    #sw t1, -14(t0)        # Store 83 S to address 0x2004-14.
