...
//    wire key_pressed_edge = key_pressed && !key_pressed_delay;
	...
	if (bus_read_enable && bus_read_done) begin bus_read_done <= 0; end
	    ...
	    if (!valid_address) bus_read_done <= 1;
	    ...
	    if (!valid_address) bus_write_done <= 1; // prevent OS hanging by invalid address r/w
	    if (Ram_selected) begin 
    ...
    wire clk_pulse_slow = (sd_status >= 9) ? (clkdiv == 1'b1) : 0;
