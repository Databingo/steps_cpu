...
mmu:  # VA 63:39Sign|38:30Vpn[2]|29:21Vpn[1]|20:12Vpn[0]|11:0PageOffset  
   ...
   # 4. Prepare for Level 1
     ...
     slli x2, x2, 12 # x5 = Address of L1 Table
   ...
   # 7. Prepare for Level 0
     ...
     slli x2, x2, 12 # x5 = Address of L0 Table
   ...
   # 9. Check valid
     andi x2, x4, 1   # check PTE valid bit
     beqz x2, FAULT
   # fall to 4KB finish
...
FINISH_2MB:
     srli x4, x4, 10 
     slli x4, x4, 12 
     li x2, 0x001ff000 # mask for VA[20:12]
     and x2, x2, x1    
     add x4, x4, x2   
     j WRITE_TLB
...
FINISH_1GB:
     ...
     li x2, 0x3ffff000 # mask for VA[29:12]
     and x2, x2, x1    # extrac from VA
     add x4, x4, x2    # add offset to PPN
     j WRITE_TLB
