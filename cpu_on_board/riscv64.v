...
//(* ram_style = "logic" *) reg tlb_d_vld [0:3]; // only 4 entries
	...
	always @(posedge clk or negedge reset) begin
		...
		Csrs[medeleg] <= 64'hb109; // delegate to S-mode 1011000100001001 15/13/12/8/3/0
		...
		casez(ir)
		    ...
		    32'b00010_??_?????_?????_01?_?????_0101111: begin  // lr Lr._mmu 3 cycles lr.w010 lr.d011
	           ...
	           // Amos(swap, add, xor, and, or, min, max) w/d
	            ...
	            32'b0000?_??_?????_?????_01?_?????_0101111, // ADD00000 Swap00001
	            32'b00100_??_?????_?????_01?_?????_0101111, // Xor00100
	            32'b01?00_??_?????_?????_01?_?????_0101111, // Or01000 And01100
	            32'b1????_??_?????_?????_01?_?????_0101111: begin // Min Max Minx Maxu 
