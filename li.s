...
## Using x2 (sp) to load Golden value !! Non-standard use !!
## Using x1 for Compare Signaling
##--------------------------------------------

## TEST: LI_ZERO
    # Purpose: Test loading zero.
    li x31, 0               # Value under test -> x31
    li x2, 0                # Golden value -> x2 (sp)
    li x1, 1                # Signal Compare (External harness should check x31 == x2)
...
#    li x2, 0x7FF            # Golden value -> x2 (sp)
#    li x1, 1                # Signal Compare
#    li x1, 0                # Clear Signal
#
...
#    li x31, -1000           # Value under test -> x31
#    li x2, -1000            # Golden value (assembler handles negative decimal) -> x2 (sp)
...
#    li x2, 0x800            # Golden value -> x2 (sp)
#    li x1, 1                # Signal Compare
#    li x1, 0                # Clear Signal
#
...
#    li x2, 100000           # Golden value -> x2 (sp)
#    li x1, 1                # Signal Compare
#    li x1, 0                # Clear Signal
#
...
#    li x2, 0x7FFFFFFF       # Golden value -> x2 (sp)
...
#    li x2, 0x00000000FFFFFFFF # Golden value (zero-extended 32-bit pattern) -> x2 (sp)
#    li x1, 1                # Signal Compare
#    li x1, 0                # Clear Signal
#
...
#    li x2, -2147483648      # Golden value -> x2 (sp)
...
#    li x2, 0x0000000080000000 # Golden value (zero-extended pattern) -> x2 (sp)
#    li x1, 1                # Signal Compare
#    li x1, 0                # Clear Signal
#
...
#    li x2, 0x123456789ABCDEF0 # Golden value -> x2 (sp)
#    li x1, 1                # Signal Compare
#    li x1, 0                # Clear Signal
#
...
#    li x2, 0x7FFFFFFFFFFFFFFF # Golden value -> x2 (sp)
#    li x1, 1                # Signal Compare
#    li x1, 0                # Clear Signal
#
...
#    li x2, 0xFFFFFFFFFFFFFFFF # Golden value -> x2 (sp)
#    li x1, 1                # Signal Compare
#    li x1, 0                # Clear Signal
#
...
#    li x2, -1                 # Golden value (should also be 0xFF...FF) -> x2 (sp)
#    li x1, 1                # Signal Compare
#    li x1, 0                # Clear Signal
#
...
#    li x2, 0x8000000000000000 # Golden value -> x2 (sp)
#    li x1, 1                # Signal Compare
#    li x1, 0                # Clear Signal
...
#    li x2, 0xC000000000000000 # Golden value -> x2 (sp)
#    li x1, 1                # Signal Compare
#    li x1, 0                # Clear Signal
#
#
